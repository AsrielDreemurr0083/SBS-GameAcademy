namespace Class4th__Iternation_Statement_
{
    internal class Program
    {
        ...
        {
            #region 반복문
            //프로그램 내에서 특별한 작업을 반복적으로 수행하는 명령문이다.
            #region 증감 연산자
            //피연산자를 하나씩 증가시키거나 감소시킬 때 사용하는 연산자다.
            ...
            //후위 증감 연산자의 경우 변화되는 값을 나중에 가지고 오기 때문에
            //추가적인 메모리가 필요하다.
            ...
            #region for문
            //초기식을 연산하여 조건식의 결과에 따라 특정한 횟수만큼 반복하는 반복문이다.

            //for문의 경우 조건이 끝나는 형태와 반대로 초기식을 연산하게 되면 조건이 일치하지 않아
            ...
            #region continue문
            //해당하는 조건문만 실행하지 않고, 반복문은 이어서 실행하는 제어문이다.
            ...
            //첫 번째 값만으로 결과가 확실할 때 두 번째 값은 확인하지 않고,
            //실행하는 방법이다.
            ...
            //암묵적으로 데이터 손실이 발생할 수 있다.

            //float fat = 5.75f;
            //int weight = fat;

            //정수형에서 실수형으로 암묵적 형변환은 가능하지만,
            //실수형에서 정수형으로 암묵적 자료형 변환을 불가능하다.
            ...
            //정수형 변수끼리 연산을 수행하게 되면 정수의 결과 값만 가질 수 있다.
