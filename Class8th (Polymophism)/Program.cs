...
{
    internal class Class8th__Polymorphism_
    {
        ...
        {
            Console.WriteLine(x + "x(int)의 값이 처리되었습니다.");
            Console.WriteLine(y + "y(int)의 값이 처리되었습니다.");
        }
        ...
        public enum State
        {
            ...
            //열거형에서 값을 특정한 위치에 새로 할당하게 되면
            //그 다음의 값은 새로 할당한 값의 +1이 된다.
        }
        ...
        {
            #region 상속
            //상위 클래스의 속성을 하위 클래스가 사용할 수 있도록 설정해주는 기능이다.
            ...
            //하위 클래스는 상위 메모리를 포함한 상태로 메모리의 크기가 결정된다.
            #endregion
            ...
            #region 다형성
            //여러 개의 서로 다른 객체가 동일한 기능을 서로 다른 방법으로 처리할 수 있는 작업이다.

            #region 함수의 오버로딩
            //같은 이름의 함수를 매개 변수의 자료형과 매개 변수의 수로
            //구분하여 여러 개를 선언할 수 있는 기능이다.
            ...
            #region 가상 함수
            //상속하는 클래스 내에서 같은 형태의 함수로 재정의될 수 있는 함수다.
            ...
            //가상 함수 실행 시간에 상위 클래스에 대한 참조로 하위 클래스에 지정된 함수를 호출할 수 있으며,
            //접근 지정자는 공개로 설정해야 한다.
            ...
            #region 배럭과제
            //Console.WriteLine("Marine : 1, Firebat : 2, Ghost : 3");
            //
            //int barrackunit = Convert.ToInt32(Console.ReadLine());
            //
            //Console.WriteLine("level 변수의 값 : " + barrackunit);
            //
            //for(int i = 0; i < 5; i++)
            //{
            //    if (barrackunit == 1)
            //    {
            //        Console.WriteLine("해병 생성");
            //    }
            //}
