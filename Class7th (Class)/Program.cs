namespace Class7th__Class_
{
    namespace Program
    {
        public class GameObject
        {
            ...
            //컴파일러가 레지스터 블록에 맞추어 바이트를 패딩해주는 최적화 작업이다.

            //클래스의 크기는 클래스를 구성하는 멤버 중에서
            //크기가 가장 큰 자료형의 배수가 되도록 설정한다.

            //클래스의 크기의 경우 멤버 변수의 순서에 따라 메모리 크기가 다르게 설정될 수 있다.
        ...
        public class Collider
        {
            ...
            public void IncreaseScore()
            {
                ...
                Console.WriteLine("score변수의 값 : " + score);
            }
        }
        ...
        public class Unit
        {
            ...
            public Unit(Unit unit)
            {
                health = unit.health;
                name = unit.name;
                //attack = unit.attack;   복사생성자
                attack = new int[3];    //깊은 복사
            }
        ...
        internal class Program
        {
            ...
            static void Main(string[] args)
            {
                ...
                //클래스를 통해 객체를 생성하여 접근하고 사용할 수 있는 집합체다.
                ...
                //블록에서 벗어나면 메모리에서 사라지는 특징을 가지고 있다.
                ...
                //프로그램이 실행될 때 메모리에 생성되고, 프로그램이 종료되어야만 메모리에서
                //사라지는 특성을 가지고 있다.
                ...
                #region 생성자
                //클래스의 인스턴스가 생성되는 시점에서 자동으로 호출되는 특수한 멤버 함수다.
                //Unit unit1 = new Unit(40,"Marine");
                //Unit unit2 = new Unit(100, "Zealot");
                //Unit unit3 = new Unit(35, "Juggling");
                //생성자의 경우 객체가 생성될 때 단 한 번만 호출되며,
                //생성자는 반환형이 존재하기 때문에 호출되기 전에는 객체에 대한 메모리는 할당되지 않는다.
                #endregion

                #region 얕은복사
                //객체를 복사할 때 주소 값을 복사하여 같은 메모리를 가리키게 하는 복사다.
