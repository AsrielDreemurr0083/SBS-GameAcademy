namespace Class3th__Conditional_Statement_
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // 4byte 크기의 실수형 자료형은 소수점 이하 6자리까지만 표기하며,
            // 8byte 크기의 실수형 자료형은 소수점 이하 15자리까지만 정확도를 표기한다.
            ...
            //오버플로우는 부호없는 자료형에서도 똑같이 발생할 수 있다.
            ...
            //관계연산자는 조건이 맞을 때 1이라는 값을 반환하며,
            //조건이 틀릴 때 0이라는 값으로 반환한다.
            ...
            #region if문
            // 어떤 특정한 조건을 비교하여 조건이 맞다면 실행되는 명령문이다.
            ...
            #region else if문
            //if문은 if문의 조건이 틀릴 때 else if문의 조건이 맞다면 실행되는 명령문이다.
            ...
            //else if문은 if문이 존재하며 여러개를 생성할 수 있다.


            #endregion

            #region else문
            // if문과 else if문의 조건이 다 틀리면 실행되는 명령문이다.
            ...
            // switch 문의 경우 조건에 해당하는 값에 따라 조건의 위치로 이동한다.
            #endregion
