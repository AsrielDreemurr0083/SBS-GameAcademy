namespace Class10th__Collection_
{
    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //C++ 템플릿은 컴파일이 1번 일어나며, C++ 템플릿은 사용하지 않으면 컴파일을 하지 않는다.
            //C# 제네릭은 컴파일이 2번 일어나며, C# 제네릭은 사용하지 않더라도 그에 관련된 정보를 저장하기 위해
            //.meta이 생성된다.

            #endregion

            #region 컬렉션
            //많은 데이터 요소를 효율적으로 관리하기 위한 자료 구조다.
            ...
            //dictionary는 Key 값의 중복을 허용하지 않는다.
            //dictionary.Add("Shoes", 2500);
