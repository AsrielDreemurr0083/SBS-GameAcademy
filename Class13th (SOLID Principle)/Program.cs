namespace Class13th__SOLID_Principle_
{
    ...
    class Controller
    {
        ...
        {
            Console.WriteLine(x + "의 값 만큼 이동");
            Console.WriteLine(y + "의 값 만큼 이동");
        }
        public void Attack()
        {
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //하나의 클래스는 하나의 기능을 담당하여 하나의 책임을
            //수행하는데 집중되어야 한다.

            #endregion

            #region 개방 폐쇠 원칙 ★(중요한 원칙)
            ...
            #region 인터페이스 분리 원칙
            //클라이언트가 자신이 이용하지 않는 함수에 의존하지 않아야 한다는 원칙이다.
